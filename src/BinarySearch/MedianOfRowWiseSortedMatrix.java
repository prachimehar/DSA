...
public class MedianOfRowWiseSortedMatrix {
    ...
    static int OptimalApproachMedian(int[][] matrix, int m, int n) {
    ...
    public static void main(String[] args) {
        ...
        int ans2 = OptimalApproachMedian(matrix, m, n);
        System.out.println("The median element by OptimalApproach is: " + ans2);
    }
